// detail.js — FINAL (batting: 2 sticky cols narrower + header overlap fix)
(function () {
  ...
  // styles (narrower sticky widths + z-index layering fix)
  (function injectStyle(){
    if (document.getElementById('tau-style')) return;
    var css =
      /* common */
      '.tau-wrap{overflow-x:auto;-webkit-overflow-scrolling:touch;margin:12px 0;}'+
      '.tau-table{border-collapse:separate;border-spacing:0;width:100%;min-width:640px;font-size:14px;line-height:1.45;}'+
      ...
      '.tau-table thead th{position:sticky;top:0;background:#f3f4f6;font-weight:700;z-index:10;color:#111 !important;}'+
      ...
      /* batting: sticky two columns (0=타순, 1=선수명) — narrower */
      '.tau-table.sticky-first th.col1,.tau-table.sticky-first td.col1{position:sticky;left:0;z-index:8;background:#fff;'+
        'min-width:48px;width:48px;text-align:center;box-shadow:2px 0 0 #e5e7eb;}'+
      '.tau-table.sticky-first th.col2,.tau-table.sticky-first td.col2{position:sticky;left:48px;z-index:7;background:#fff;'+
        'min-width:160px;width:160px;box-shadow:2px 0 0 #e5e7eb;}'+
      /* header cells should be above body sticky cells */
      '.tau-table.sticky-first thead th.col1{z-index:12;}'+
      '.tau-table.sticky-first thead th.col2{z-index:11;}'+

      /* mobile tweak: even narrower */
      '@media (max-width:480px){'+
        '.tau-table{min-width:560px;font-size:13px}'+
        '.tau-table.sticky-first th.col1,.tau-table.sticky-first td.col1{min-width:44px;width:44px}'+
        '.tau-table.sticky-first th.col2,.tau-table.sticky-first td.col2{min-width:140px;width:140px;left:44px}'+
        '.tau-table.sticky-first td.col2{z-index:7}'+
      '}'+
      ...
      '.tau-scoreboard thead th{position:static !important;top:auto !important;z-index:auto !important;}'+
  ...
  (function run(){
    getJSON('./detail.json').then(function(db){
